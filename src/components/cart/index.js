...
export default function Cart({cart, updateCoupon, flag}) {
    return (
        <div className="card outlined my-16 mr-25 flex-30">
            ...
            <div className="color layout-row font-weight-light justify-content-between align-items-center px-8 mx-12">
                {flag ? <span>Please add items to the cart</span> : ""}       
            </div>
        </div>
    );
}
